...
/**
 * Catálogo de apps disponíveis para o grid. Quais deles aparecem de fato é decidido
 * pelo usuário e persistido em [AppPreferences] — este objeto é só a lista mestre.
 */
object AppCatalog {
    val all: List<AppItem> = listOf(
